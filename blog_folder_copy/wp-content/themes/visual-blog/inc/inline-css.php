 ...
 $vb_menu_hcolor = get_theme_mod('vb_menu_hcolor','#555');
        ...
        $style = '';
         ...
         if($vb_menu_bgcolor != '#f8f9fa'){ 
         	$style .= 'body nav.vblog-menu,.dropdown-menu,.dropdown-item:focus, .dropdown-item:hover{
                    background: '.esc_attr($vb_menu_bgcolor).' !important;
                }';
         }
         if($vb_menu_color != '#f8f9fa'){ 
         	$style .= '.navbar-light .navbar-nav .nav-link, .navbar-light .navbar-nav .dropdown-item{
                    color: '.esc_attr($vb_menu_color).' !important;
                }';
         }
         if($vb_menu_hcolor != '#f8f9fa'){ 
         	$style .= '.navbar-light .navbar-nav .active>.nav-link, .navbar-light .navbar-nav .nav-link.active, .navbar-light .navbar-nav .nav-link.show, .navbar-light .navbar-nav .show>.nav-link,.navbar-light .navbar-nav .nav-link:focus, .navbar-light .navbar-nav .nav-link:hover,.navbar-light .navbar-nav .dropdown-item:focus, .navbar-light .navbar-nav .dropdown-item:hover{
